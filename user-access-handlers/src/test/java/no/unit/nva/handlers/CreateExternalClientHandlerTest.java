...
public class CreateExternalClientHandlerTest extends HandlerTest {
        ...
        DescribeResourceServerResponse.builder()
            .resourceServer(
                ResourceServerType.builder()
                    ...
                    .build())
            .build();
    when(mock.describeResourceServer(any(DescribeResourceServerRequest.class)))
        .thenReturn(resourceServerResponse);
        ...
        .thenAnswer(
            (Answer)
                invocation -> {
                  ...
                  if (request.allowedOAuthScopes().stream()
                      .anyMatch(it -> it.equals(INVALID_SCOPE))) {
                  ...
                  var response =
                      CreateUserPoolClientResponse.builder().userPoolClient(userPoolClient).build();
                  return response;
                });
  ...
  public void clientShouldBeStoredToDatabase() throws IOException, NotFoundException {
    ...
    var expected = ClientDto.newBuilder().withClientId(CLIENT_ID).withCustomer(customer).build();
  ...
  public void shouldInformCallerOfInvalidRequestedScopes() throws IOException {
    ...
    var scopes = List.of(validScope, INVALID_SCOPE);
  ...
  @Test
  public void shouldReturnBadRequestWhenScopeIsMissingInRequest()
  ...
  @Test
  public void shouldReturnBadRequestWhenCustomerIsMissingInRequest()
      throws IOException, URISyntaxException {
    var request =
        CreateExternalClientRequest.newBuilder()
            .withClientName(CLIENT_NAME)
