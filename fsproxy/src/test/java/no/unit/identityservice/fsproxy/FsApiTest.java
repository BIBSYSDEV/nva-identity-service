...
public class FsApiTest {
  ...
  void shouldThrowExceptionWhenPersonIsNotFoundInFs() {
    ...
    assertThrows(
        UserPrincipalNotFoundException.class, () -> fsApi.fetchCoursesForPerson(personNotInFs));
  }
  ...
  @Test
  void shouldReturnEmptyCourseListWhenPersonIsNotSignedUpToAnyCourses()
    ...
    var expectedCourses =
        Stream.concat(coursesIfStaff.stream(), coursesIfStudent.stream())
