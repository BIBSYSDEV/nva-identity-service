...
class GetCustomerDoiHandlerTest {
  ...
  @Test
  void handleRequestReturnsOkWhenARequestWithAnExistingIdentifier()
  ...
  private <T> GatewayResponse<T> sendRequest(UUID identifier, Class<T> responseType)
      throws IOException {
  ...
  private InputStream createRequestWithMediaType(UUID identifier) throws JsonProcessingException {
  ...
  void handleRequestReturnsDefaultDoiWhenNoSecretsExists() throws IOException, NotFoundException {
    ...
    when(secretsReaderMock.fetchSecret(any(), any())).thenReturn(null);
  ...
  void handleRequestWhenJsonSecretsAreCorrupt() throws IOException {
    ...
    when(secretsReaderMock.fetchSecret(any(), any())).thenThrow(ErrorReadingSecretException.class);
  ...
  private <T> GatewayResponse<T> sendFailedRequest(UUID identifier, Class<T> responseType)
      throws IOException {
    var request =
