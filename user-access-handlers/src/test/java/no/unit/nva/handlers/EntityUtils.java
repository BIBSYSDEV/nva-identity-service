...
public final class EntityUtils {
  ...
  public static final Set<AccessRight> SAMPLE_ACCESS_RIGHTS = Collections.singleton(MANAGE_DOI);
   ...
   *
   * @throws InvalidEntryInternalException When the user is invalid. The user is supposed to be a
   *     valid user.
   */
  public static UserDto createUserWithRolesAndInstitution() throws InvalidEntryInternalException {
    return createUserWithRoleWithoutInstitution().copy().withInstitution(SOME_INSTITUTION).build();
  }
