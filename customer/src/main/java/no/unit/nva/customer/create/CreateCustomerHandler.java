...
public class CreateCustomerHandler extends CustomerHandler<CreateCustomerRequest> {
  ...
  protected void validateRequest(
      CreateCustomerRequest createCustomerRequest, RequestInfo requestInfo, Context context)
  ...
  protected CustomerDto processInput(
      CreateCustomerRequest input, RequestInfo requestInfo, Context context)
      throws ApiGatewayException {
