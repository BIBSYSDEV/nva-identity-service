...
public abstract class WriteControlledVocabularyHandler
  ...
  protected WriteControlledVocabularyHandler(
      CustomerService customerService, Environment environment) {
    super(customerService, VocabularyList.class, environment);
  }

  @Override
  protected final VocabularyList processInput(
      VocabularyList input, RequestInfo requestInfo, Context context) throws ApiGatewayException {
  ...
  protected abstract CustomerDto updateVocabularySettings(
      VocabularyList input, CustomerDto customer) throws ApiGatewayException;
