...
class ChannelConstraintPolicyTest {
  ...
  private final String ERROR_MESSAGE_TEMPLATE =
      "%s not a valid ChannelConstraintPolicy, expected one of: %s";
  ...
  void shouldThrowRuntimeExceptionWhenInputIsInvalid() {
    ...
    var expected =
        format(
            ...
            NONSENSE,
            stream(ChannelConstraintPolicy.values())
                .map(ChannelConstraintPolicy::toString)
