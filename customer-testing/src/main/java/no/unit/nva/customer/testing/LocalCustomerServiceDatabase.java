...
public class LocalCustomerServiceDatabase {
    ...
    List<AttributeDefinition> attributeDefinitions =
        asList(
            AttributeDefinition.builder()
                ...
                .build(),
            AttributeDefinition.builder()
                .attributeName(ORG_DOMAIN)
                .attributeType(ScalarAttributeType.S)
                .build(),
            AttributeDefinition.builder()
                .attributeName(CRISTIN_ID)
                .attributeType(ScalarAttributeType.S)
                .build());
  ...
  private GlobalSecondaryIndex createGsi(
      List<KeySchemaElement> byCristinIdKeyScheme, Projection allProjection, String cristinId) {
