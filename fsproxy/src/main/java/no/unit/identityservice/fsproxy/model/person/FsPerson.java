...
public class FsPerson implements JsonSerializable {
  ...
  @JsonCreator
  public FsPerson(
      @JsonProperty(FS_IDENTIFIER_FIELD) FsIdNumber fsIdNumber,
  ...
  public boolean equals(Object o) {
    ...
    return fsIdNumber.equals(fsPerson.fsIdNumber)
        && fagperson.equals(fsPerson.fagperson)
        && birthDate.equals(fsPerson.birthDate)
        && personalNumber.equals(fsPerson.personalNumber);
  }
