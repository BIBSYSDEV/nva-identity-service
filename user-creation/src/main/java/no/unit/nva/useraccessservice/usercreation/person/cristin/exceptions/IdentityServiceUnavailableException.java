 ...
 * connection problems, timeouts, or other infrastructure-related failures. This is different from
 * IdentityServiceUpstreamInternalServerErrorException which indicates that the service responded
 * with a 500+ error.
 */
public class IdentityServiceUnavailableException extends IdentityServiceException {
  ...
  public static IdentityServiceUnavailableException withDetails(String uri, Throwable cause) {
    var message =
        String.format(
            "Unable to connect to Person Registry at %s: %s",
            uri,
