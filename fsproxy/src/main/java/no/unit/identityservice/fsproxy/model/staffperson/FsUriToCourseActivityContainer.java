...
public class FsUriToCourseActivityContainer implements JsonSerializable {
  ...
  @JsonCreator
  public FsUriToCourseActivityContainer(
      @JsonProperty("undervisningsaktivitet") FsUriToCourseActivity courseUri) {
    this.courseUri = courseUri;
  }

  public static FsUriToCourseActivityContainer fromJson(String responseBody)
