...
class CustomerDaoTest {
  ...
  void toCustomerDaoToDtoAndBackReturnsWithLossOfSecret() {
    ...
    customerDto.getDoiAgent().addPassword(randomString());
  ...
  private Set<VocabularyDao> randomVocabularySettings() {
    VocabularyDao vocabulary =
        new VocabularyDao(randomString(), randomUri(), randomElement(VocabularyStatus.values()));
