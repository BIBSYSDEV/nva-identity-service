...
class SetImpersonationHandlerTest {
  ...
  @Test
  public void shouldReturn200okWhenUserIsAppAdminAndIsNotImpersonatingSomeoneAlready()
      throws IOException {
  ...
  private InputStream createDefaultRequestForImpersonation(String impersonatingFnr)
  ...
  @Test
  public void
      shouldCallCognitoAdminApiWithImpersonatedFnrWhenUserIsAppAdminAndIsNotImpersonatingSomeoneAlready()
          throws IOException {
