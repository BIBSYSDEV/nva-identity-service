...
class HandlerWithEventualConsistencyTest {
  ...
  public static final HandlerWithEventualConsistency<String, String> handler =
      getHandlerWithEventualConsistency();

  private static HandlerWithEventualConsistency<String, String>
      getHandlerWithEventualConsistency() {
  ...
  void errorsShouldBeLogged() {
    ...
    var expectedLogValue =
        String.format(FAILED_TO_FETCH_OBJECT, 0, MAX_EFFORTS_FOR_FETCHING_OBJECT);
