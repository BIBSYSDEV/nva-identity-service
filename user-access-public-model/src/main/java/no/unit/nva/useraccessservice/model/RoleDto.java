...
public class RoleDto implements WithCopy<Builder>, Validable, Typed {
  ...
  public static RoleDto fromJson(String json) throws BadRequestException, InvalidInputException {
    var roleDto =
        attempt(() -> JsonConfig.readValue(json, RoleDto.class))
  ...
  @Override
  public Builder copy() {
    return new Builder().withAccessRights(this.getAccessRights()).withRoleName(this.getRoleName());
  }
  ...
  public boolean isValid() {
    return Optional.ofNullable(getRoleName())
