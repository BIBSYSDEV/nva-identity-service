...
public class UserList implements Typed {
  ...
  /**
   * This method avoids creating a copy of the input parameter. The input parameter is the actual
   * list that is contained in the {@link UserList}. The {@link ArrayList} constuctor that accepts a
   * {@link Collection} creates a physical copy of the array that is holding the data.
   *
