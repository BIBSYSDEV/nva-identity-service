...
class UserSelectionUponLoginHandlerTest {
    ...
    private static void assertThatResponseContainsAssignedAccessRights(
        ...
        var groupsList = getGroupsList(response);
    ...
    private static List<String> getGroupsList(CognitoUserPoolPreTokenGenerationEventV2 input) {
    ...
    private List<String> extractAccessRights(CognitoUserPoolPreTokenGenerationEventV2 input) {
        return getGroupsList(input);
    }
}