...
class StopImpersonationHandlerTest {
  ...
  private InputStream createDefaultRequestForStopImpersonation(String username)
  ...
  @Test
  public void shouldCallCognitoAdminApiWithUsernameOfUser() throws IOException {
  ...
  @Test
  public void shouldCallCogntioAdminApiWithEmptyStringImpersonation() throws IOException {
    var request = createDefaultRequestForStopImpersonation(randomString());
    handler.handleRequest(request, outputStream, context);
