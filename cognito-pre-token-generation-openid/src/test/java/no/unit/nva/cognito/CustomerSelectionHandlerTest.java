...
class CustomerSelectionHandlerTest {
  ...
  @Test
  void shouldUpdateSelectedCustomerWhenValidOptions() throws IOException {
  ...
  @Test
  void shouldNotUpdateSelectedCustomerWhenInvalidOptions() throws IOException {
  ...
  private String extractAttributeUpdate(String attributeName) {
    ...
    return request.userAttributes().stream()
