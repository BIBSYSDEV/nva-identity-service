...
public class FsCourseItemContainingCourseContainer {
  ...
  @JsonCreator
  public FsCourseItemContainingCourseContainer(
      @JsonProperty("id") FsCourseContainer fsCourseContainer) {
    this.fsCourseContainer = fsCourseContainer;
  }

  public static List<FsCourseItemContainingCourseContainer> fromCourseList(
      List<FsCourse> fsCourses) {
