...
public record TermsConditions(
  ...
  @DynamoDbIgnore
  @Override
  public TermsConditions upsert(DataAccessService<TermsConditions> service)
  ...
  @DynamoDbIgnore
  @Override
  public TermsConditions fetch(DataAccessService<TermsConditions> service)
      throws NotFoundException {
  ...
  public static class Builder {
    ...
    public TermsConditions build() {
      ...
      return new TermsConditions(
          withId, withType, createdInstant, withOwner, modifiedInstant, modifiedById, termsUri);
    }
