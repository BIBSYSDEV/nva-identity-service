...
public class DefaultRoleSource implements RoleSource {
  ...
  public static final RoleDto PUBLISHING_CURATOR_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.PUBLISHING_CURATOR)
          .withAccessRights(
              List.of(MANAGE_RESOURCES_STANDARD, MANAGE_PUBLISHING_REQUESTS, MANAGE_RESOURCE_FILES))
          .build();
  public static final RoleDto NVI_CURATOR_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.NVI_CURATOR)
          .withAccessRights(List.of(MANAGE_RESOURCES_STANDARD, MANAGE_NVI_CANDIDATES))
          .build();
  public static final RoleDto DOI_CURATOR_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.DOI_CURATOR)
          .withAccessRights(List.of(MANAGE_RESOURCES_STANDARD, MANAGE_DOI))
          .build();
  public static final RoleDto SUPPORT_CURATOR_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.SUPPORT_CURATOR)
          .withAccessRights(List.of(MANAGE_RESOURCES_STANDARD, SUPPORT))
          .build();
  private static final RoleDto CREATOR_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.CREATOR)
          .withAccessRights(List.of(MANAGE_OWN_RESOURCES))
          .build();
  private static final RoleDto INSTITUTION_ADMIN_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.INSTITUTION_ADMIN)
          .withAccessRights(List.of(MANAGE_OWN_AFFILIATION))
          .build();

  private static final RoleDto INTERNAL_IMPORTER =
      RoleDto.newBuilder()
          .withRoleName(RoleName.INTERNAL_IMPORTER)
          .withAccessRights(List.of(MANAGE_IMPORT))
          .build();

  private static final RoleDto CURATOR_THESIS_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.THESIS_CURATOR)
          .withAccessRights(List.of(MANAGE_RESOURCES_STANDARD, MANAGE_DEGREE))
          .build();

  private static final RoleDto CURATOR_THESIS_EMBARGO_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.EMBARGO_THESIS_CURATOR)
          .withAccessRights(List.of(MANAGE_RESOURCES_STANDARD, MANAGE_DEGREE_EMBARGO))
          .build();

  private static final RoleDto APPLICATION_ADMIN_ROLE =
      RoleDto.newBuilder()
  ...
  private static final RoleDto EDITOR_ROLE =
      RoleDto.newBuilder()
          .withRoleName(RoleName.EDITOR)
          .withAccessRights(
              List.of(MANAGE_OWN_AFFILIATION, MANAGE_RESOURCES_ALL, MANAGE_ALL_PROJECTS))
          .build();
