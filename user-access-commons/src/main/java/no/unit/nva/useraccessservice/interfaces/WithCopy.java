 ...
 * }</pre>
 *
 * <p>In the above example, {@code MyClass} has two fields, fieldA, and fieldB. <br>
 * Object {@code obj} has values {@code "someValue"} and {@code "someOtherValue"} while <br>
 * Object {@code copy} has values {@code "someValue"} and {@code "aThirdValue"}.
 *
