...
public abstract class CustomerDoiHandler<I> extends ApiGatewayHandler<I, String> {
  ...
  protected Map<UUID, SecretManagerDoiAgentDao> getSecretsManagerDoiAgent()
      throws JsonProcessingException {

    var secretAsStringJsonArray =
        secretsReader.fetchSecret(SECRETS_KEY_AND_NAME, SECRETS_KEY_AND_NAME);
    ...
    return Arrays.stream(
        ...
        .collect(
            Collectors.toConcurrentMap(
                this::extractKey, doiAgent -> doiAgent, SecretManagerDoiAgentDao::merge));
  }
  ...
  private UUID toUuid(URI customerId) {
    return UUID.fromString(UriWrapper.fromUri(customerId).getLastPathElement());
  }
