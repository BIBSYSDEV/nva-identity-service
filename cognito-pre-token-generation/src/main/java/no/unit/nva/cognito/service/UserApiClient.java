...
public class UserApiClient implements UserApi {
    ...
    public static final String PATH = "/service/users";
    ...
    public UserApiClient(HttpClient httpClient,
        ...
        this.userApiBaseUrl = environment.readEnv(USER_API_BASE_URL);
    ...
    private URI formUri() throws URISyntaxException {
        URI uri = new URI(userApiBaseUrl + PATH);
        logger.info("POST UserUri:" + uri);
        return uri;
    }
