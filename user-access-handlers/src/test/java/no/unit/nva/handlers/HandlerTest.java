...
public class HandlerTest extends LocalIdentityService {
  ...
  protected UserDto createSampleUserAndInsertUserRoles(
      String username, URI institution, RoleName roleName) throws InvalidEntryInternalException {
  ...
  protected UserDto createSampleUser(String username, URI institution)
      throws InvalidEntryInternalException {
    RoleDto someRole =
