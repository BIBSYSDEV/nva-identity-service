...
public class CreateCustomerHandlerTest extends LocalCustomerServiceDatabase {
  ...
  private <I, O> GatewayResponse<O> executeRequestWithAuthorization(
      I request, URI authorizedCustomer, Class<O> responseType) throws IOException {
    outputSteam = new ByteArrayOutputStream();
    var input =
  ...
  void shouldReturnDefaultPublicationWorkflowWhenNoneIsSet()
    ...
    assertThat(
        actualResponseBody.getPublicationWorkflow(),
        is(equalTo(REGISTRATOR_PUBLISHES_METADATA_AND_FILES)));
  }
  ...
  @Test
  void shouldReturnDefaultRboInstitutionFalseWhenNoneIsSet()
      throws BadRequestException, IOException {
    var requestBody = CreateCustomerRequest.fromCustomerDto(validCustomerDto());
    var response = executeRequest(requestBody, CustomerDto.class);
    var actualResponseBody = CustomerDto.fromJson(response.getBody());
  ...
  @Test
  void shouldReturnDefaultInactiveFromEqualToNullWhenNoneIsSet()
      throws BadRequestException, IOException {
    var requestBody = CreateCustomerRequest.fromCustomerDto(validCustomerDto());
    var response = executeRequest(requestBody, CustomerDto.class);
    var actualResponseBody = CustomerDto.fromJson(response.getBody());
  ...
  void shouldReturnInactiveFromWhenValueIsSet() throws BadRequestException, IOException {
    ...
    var customerDto =
        CustomerDto.builder().withName("New Customer").withInactiveFrom(inactiveFrom).build();
  ...
  void shouldReturnPublicationWorkflowWhenValueIsSet() throws BadRequestException, IOException {
    ...
    assertThat(
        actualResponseBody.getPublicationWorkflow(),
        is(equalTo(REGISTRATOR_PUBLISHES_METADATA_ONLY)));
  }
  ...
  void shouldReturnPublicationWorkflowErrorWhenValueIsWrong() throws IOException {
    var customerDto =
        CustomerDto.builder()
            ...
            .build();
    var requestBody =
        CreateCustomerRequest.fromCustomerDto(customerDto)
            .toString()
  ...
  void shouldReturnGeneralSupportEnabledWhenValueIsSet() throws BadRequestException, IOException {
    var customerDto =
        CustomerDto.builder().withName("New Customer").withGeneralSupportEnabled(true).build();
    var requestBody = CreateCustomerRequest.fromCustomerDto(customerDto);
    var response = executeRequest(requestBody, CustomerDto.class);
    var actualResponseBody = CustomerDto.fromJson(response.getBody());
  ...
  void shouldReturnBadRequestWhenInputIsNotAValidCustomerRequest() throws IOException {
    ...
    var input =
        new HandlerRequestBuilder<String>(dtoObjectMapper)
  ...
  @Test
  void shouldReturnConflictErrorWhenTryingToCreateCustomerForInstitutionThatIsAleadyCustomer()
      throws IOException {
    var requestBody = CreateCustomerRequest.fromCustomerDto(validCustomerDto());
  ...
  private GatewayResponse<CustomerDto> insertCustomerWithSameInstitutionId(
      CreateCustomerRequest requestBody) throws IOException {
  ...
  private <I, O> GatewayResponse<O> executeRequestWithoutAuthorization(
      I request, URI authorizedCustomer, Class<O> responseType) throws IOException {
    outputSteam = new ByteArrayOutputStream();
    var input =
        new HandlerRequestBuilder<I>(dtoObjectMapper)
  ...
  @Test
  void shouldReturnPublicationInstanceTypesWhenValueIsSet()
      throws BadRequestException, IOException {
    ...
    Set<PublicationInstanceTypes> actualSet =
        new HashSet<>(actualResponseBody.getAllowFileUploadForTypes());
  ...
  void shouldReturnAllPublicationInstanceTypesWhenAllowFileUploadForTypesIsNullOrEmpty(
      Set<PublicationInstanceTypes> allowFileUploadForTypes)
      throws BadRequestException, IOException {
    var customerDto =
        CustomerDto.builder()
            .withName("New Customer")
    ...
    assertThat(
        actualResponseBody.getAllowFileUploadForTypes(),
