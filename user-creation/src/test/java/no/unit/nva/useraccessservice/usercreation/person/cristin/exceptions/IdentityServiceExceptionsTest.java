...
class IdentityServiceExceptionsTest {
  ...
  void identityServiceNotFoundExceptionShouldHaveCorrectMessage() {
    ...
    assertThat(
        ...
        containsString("IdentityService-2001: Person with id 123 not found"));
  }
  ...
  void identityServiceUpstreamInternalServerErrorExceptionShouldAcceptCause() {
    ...
    var exception =
        new IdentityServiceUpstreamInternalServerErrorException("Upstream error", cause);
  ...
  void identityServiceMissingRequiredFieldsExceptionShouldReturn400StatusCode() {
    var exception =
        new IdentityServiceMissingRequiredFieldsException(
  ...
  void identityServiceCreateFailedExceptionShouldReturn502StatusCode() {
    ...
    assertThat(
        exception.getMessage(), containsString("IdentityService-3003: Failed to create person"));
    assertThat(exception.getCause(), is(equalTo(cause)));
  }
  ...
  void identityServiceExceptionBaseClassShouldAcceptCause() {
    ...
    var exception =
        new IdentityServiceException(
            IdentityServiceErrorCodes.GENERIC_ERROR, "Generic error", cause);
  ...
  void identityServiceAlreadyExistsExceptionShouldReturn409StatusCode() {
    ...
    assertThat(
        exception.getMessage(), containsString("IdentityService-2002: Person already exists"));
  }
  ...
  void identityServiceUnavailableExceptionWithDetailsShouldFormatMessage() {
    var cause = new IOException("Connection timeout");
    var exception =
        IdentityServiceUnavailableException.withDetails(
            "https://api.cristin.no/persons/123", cause);
  ...
  void identityServiceMissingNinExceptionShouldReturn400StatusCode() {
    ...
    assertThat(
        exception.getMessage(),
        containsString(
            "IdentityService-1003: Missing National Identity Number in user attributes"));
  }
  ...
  void identityServiceMissingNinExceptionShouldAcceptCustomMessage() {
    ...
    assertThat(exception.getErrorCode(), is(equalTo("1003")));
    assertThat(
        exception.getMessage(), containsString("IdentityService-1003: Custom NIN missing message"));
  }
