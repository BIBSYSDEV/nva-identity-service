...
public class UpdateControlledVocabularyHandlerTest
    extends CreateUpdateControlledVocabularySettingsTests {
  ...
  @Test
  public void handleRequestReturnsAcceptedWhenUpdatingVocabularyForExistingCustomer()
      throws IOException {
  ...
  @Test
  public void
      handleRequestSavesVocabularySettingsToDatabaseWhenUpdatingSettingsForExistingCustomer()
  ...
  @Test
  public void handleRequestReturnsBadRequestWhenInputBodyIsNotValid() throws IOException {
  ...
  @Test
  public void handleRequestReturnsResponseWithContentTypeJsonLdWhenAcceptHeaderIsJsonLd()
      throws IOException {
    var response = sendRequestAcceptingJsonLd(existingIdentifier()).getResponse();
    assertThat(
        responseContentType(response), is(equalTo(MediaTypes.APPLICATION_JSON_LD.toString())));
  }

  @Test
  public void handleRequestReturnsResponseWithContentTypeJsonWhenAcceptHeaderIsJson()
      throws IOException {
  ...
  @Test
  public void handleRequestReturnsUnsupportedTypeWhenAcceptedContentTypeIsNotSupported()
      throws IOException {
  ...
  @Test
  public void
      handleRequestReturnsBadRequestWhenCustomerAlreadyHasVocabularySettingsAndWeAttemptToEraseThem()
  ...
  @Test
  public void
      handleRequestReturnsUpdatedVocabularyListWhenUserWithAccessRightManageOwnAffiliationsUpdatesVocabulary()
          throws IOException {
    var result =
        sendRequestWithAccessRight(existingIdentifier(), AccessRight.MANAGE_OWN_AFFILIATION);
    var actualBody = VocabularyList.fromJson(result.getResponse().getBody());
    assertThat(actualBody, is(equalTo(result.getExpectedBody())));
  }
}
