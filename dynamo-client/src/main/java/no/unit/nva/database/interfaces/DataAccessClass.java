...
/**
 * Interface for data access classes, although it has a document based philosophy, it can be used
 * with any database.
 *
...
public interface DataAccessClass<T extends DataAccessClass<T>> {
  ...
  /**
   * Returns current owner of the object. You may wonder why not call this creator, but the creator
   * is the user that created the object, not necessarily the current owner.
   *
   * <p>To find the creator, you will have to look up the history of the object.
   *
