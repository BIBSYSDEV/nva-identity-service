...
public final class DatabaseIndexDetails {
    ...
    public static final String SECONDARY_INDEX_2_HASH_KEY = "SecondaryIndex2HashKey";
    public static final String SECONDARY_INDEX_2_RANGE_KEY = "SecondaryIndex2RangeKey";

    public static final String SEARCH_USERS_BY_INSTITUTION_INDEX_NAME = "SearchUsersByInstitution";
    public static final String SEARCH_USERS_BY_CRISTIN_IDENTIFIERS = "SearchUsersByCristinIdentifiers";
