...
public interface DynamoEntryWithRangeKey extends Typed {
  ...
  /**
   * Setter of the primary hash key. This method is supposed to be used only by when deserializing
   * an item using Json serializer.
   *
  ...
  /**
   * Setter of the primary range key. This method is supposed to be used only by when deserializing
   * an item using Json serializer.
   *
