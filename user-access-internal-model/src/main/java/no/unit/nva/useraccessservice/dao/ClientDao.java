...
public class ClientDao implements DynamoEntryWithRangeKey, WithCopy<Builder> {
  ...
  /**
   * @param cristinOrgUri Method to be used only by DynamoDb mapper. Do not use. Use the builder
   *     instead.
   */
  ...
  /**
   * @param actingUser Method to be used only by DynamoDb mapper. Do not use. Use the builder
   *     instead.
   */
