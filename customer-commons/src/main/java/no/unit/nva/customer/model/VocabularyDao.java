...
public class VocabularyDao implements Vocabulary {
  ...
  public static final AttributeConverter<Set<VocabularyDao>> SET_CONVERTER =
      new VocabularySetConverter();
  public static final TableSchema<VocabularyDao> SCHEMA =
      TableSchema.fromClass(VocabularyDao.class);
